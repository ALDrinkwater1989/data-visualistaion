...
function makeGraphs(error, salaryData) {
    ...
    show_discpline_selector(ndx);

    show_percent_professors(ndx, "Female", "#percent-of-women-professors");
    show_percent_professors(ndx, "Male", "#percent-of-men-professors");
    
    show_gender_balance(ndx);
    show_average_salary(ndx);
    show_rank_distribution(ndx);
    
    show_service_salary(ndx);
    show_phd_salary(ndx);
...
function show_discpline_selector(ndx) {
...
function show_percent_professors(ndx, gender, element) {
...
function show_average_salary(ndx) {
    ...
    var averageSalary = dim.group().reduce(add_item, reduce_item, initialise);
...
function show_rank_distribution(ndx) {
    ...
    function ranByGender(dimension, rank) {
    ...
    var dim = ndx.dimension(dc.pluck('sex'));
    var profByGender = ranByGender(dim, "Prof");
    var asstProfByGender = ranByGender(dim, "AsstProf");
    var assocProfByGender = ranByGender(dim, "AssocProf");
...
function show_service_salary(ndx){
